          ...
          loading = true;
                ...
                //    if(type!="compact"){
                  ...
                  //  }
                    ...
                    ctlStorySlideshow(timeline_wrp);
                    naviLoadMoreBtn();
...
if(typeof ct_load_more != 'undefined' && typeof ct_load_more.attribute != 'undefined') 
 ...
 //    parent_wrp.find(".ctl_load_more").hide();
  ...
  // stories slideshow 
function ctlStorySlideshow(timelineWrapper){
    var slideShowWrapper=timelineWrapper.find('.ctl_flexslider');
    var animation=slideShowWrapper.attr('data-animation');
    var slideshow_op=slideShowWrapper.attr('data-slideshow');
    var animationSpeed=slideShowWrapper.attr('data-animationSpeed');
...
// year navigation load more function
  function naviLoadMoreBtn(){
    if($(".cool_timeline").find(".ctl_load_more").length && $("body").find(".ctl-bullets-container ul li").length){
    var buttonHtml='<button data-text="..Loading" class="ctl_load_more_clone">Load More</button>'
   $(".ctl-bullets-container ul").after(buttonHtml);
